...
const bootstrapFile = path.join(homeDir, '.gemini', 'superpowers', '.codex', 'superpowers-bootstrap.md');
...
function runFindSkills() {
    ...
    console.log('Usage:');
    console.log('  gemini-superpowers use-skill <skill-name>   # Load a specific skill');
    console.log('');
...
function runBootstrap() {
    ...
    console.log('# Use "gemini-superpowers use-skill <skill>" to load and apply skills.');
    console.log('# Remember: If a skill applies to your task, you MUST use it!');
}

function runUseSkill(skillName) {
    if (!skillName) {
        console.log('Usage: gemini-superpowers use-skill <skill-name>');
        console.log('Examples:');
        console.log('  gemini-superpowers use-skill superpowers:brainstorming  # Load superpowers skill');
        console.log('  gemini-superpowers use-skill brainstorming              # Load personal skill (or superpowers if not found)');
        console.log('  gemini-superpowers use-skill my-custom-skill            # Load personal skill');
        return;
    }
...
switch (command) {
    ...
    default:
        ...
        console.log('Usage:');
        console.log('  gemini-superpowers bootstrap              # Run complete bootstrap with all skills');
        console.log('  gemini-superpowers use-skill <skill-name> # Load a specific skill');
        console.log('  gemini-superpowers find-skills            # List all available skills');
        console.log('');
        console.log('Examples:');
        console.log('  gemini-superpowers bootstrap');
        console.log('  gemini-superpowers use-skill superpowers:brainstorming');
        console.log('  gemini-superpowers use-skill my-custom-skill');
        break;
}
